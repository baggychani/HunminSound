...
import { TranslatedDescription } from '@/legacy/components/showcase/TranslatedDescription'
import { TranslatedVowelArticulation } from '@/legacy/components/showcase/TranslatedVowelArticulation'
import { VOWEL_ARTICULATION_KO } from '@/lib/vowelArticulation'
import { JamoText } from '@/components/ui/JamoText'
import type { ChartViewMode } from '@/legacy/components/showcase/PhoneticsViewToggle'
import { HunminZoneHeading } from '@/legacy/components/showcase/hunmin/HunminChartParts'
import { PhoneticsHaeryeSource } from '@/legacy/components/showcase/phonetics/PhoneticsHaeryeSource'
import {
  HUNMIN_VOWEL_GLYPH_RAIL_CLASS,
  HunminVowelImageGlyph,
  HunminVowelJamoGlyph,
  HunminVowelZone,
} from '@/legacy/components/showcase/hunmin/HunminVowelZone'
import {
  HUNMIN_VOWEL_ROWS,
