  ...
  return (
    ...
    >
      <motion.div
        ...
        className="absolute inset-x-0 top-[-7vh] h-[calc(100%+7vh)] origin-right scale-[0.8] opacity-[0.46] blur-[0.6px] saturate-[0.88] translate-x-[14vw] sm:top-[-7.5vh] sm:h-[calc(100%+7.5vh)] sm:translate-x-[16vw] lg:top-[-8vh] lg:h-[calc(100%+8vh)] lg:translate-x-[18vw]"
        style={{
