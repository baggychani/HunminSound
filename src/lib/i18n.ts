...
const ko = {
  ...
  hunminInitialSub: '자음자 · 初聲',
  hunminMedialTitle: '중성자',
  hunminMedialSub: '모음자 · 中聲',
  hunminAppraisalTitle: '해례본의 평가',
  hunminAppraisalSub: '정인지서 · 鄭麟趾序',
  hunminEditorialNote: '일러두기',
  hunminEditorialShow: '일러두기 펼치기',
  hunminEditorialHide: '일러두기 접기',
...
const en: Messages = {
  ...
  hunminInitialSub: 'Choseong · 初聲',
  hunminMedialTitle: 'Medial Vowels',
  hunminMedialSub: 'Jungseong · 中聲',
  hunminAppraisalTitle: 'Appraisal in the Haerye',
  hunminAppraisalSub: 'Jeong In-ji Preface · 鄭麟趾序',
  hunminEditorialNote: "Editor's Note",
  hunminEditorialShow: "Show editor's note",
  hunminEditorialHide: "Hide editor's note",
  hunminEditorialSource:
...
const zh: Messages = {
  ...
  hunminInitialSub: '辅音字 · 初聲',
  hunminMedialTitle: '中声字',
  hunminMedialSub: '元音字 · 中聲',
  hunminAppraisalTitle: '解例本评价',
  hunminAppraisalSub: '郑麟趾序 · 鄭麟趾序',
  hunminEditorialNote: '凡例',
  hunminEditorialShow: '展开凡例',
  hunminEditorialHide: '收起凡例',
  hunminEditorialSource:
...
const ja: Messages = {
  ...
  admin: '管理者ページ',
  hunminInitialTitle: '初声字',
  hunminInitialSub: '子音字 · 初聲',
  hunminMedialTitle: '中声字',
  hunminMedialSub: '母音字 · 中聲',
  hunminAppraisalTitle: '解例本の評価',
  hunminAppraisalSub: '鄭麟趾序 · 鄭麟趾序',
  hunminEditorialNote: '凡例',
  hunminEditorialShow: '凡例を開く',
  hunminEditorialHide: '凡例を閉じる',
  hunminEditorialSource:
...
const fr: Messages = {
  ...
  hunminInitialSub: 'Choseong · 初聲',
  hunminMedialTitle: 'Voyelles médianes',
  hunminMedialSub: 'Jungseong · 中聲',
  hunminAppraisalTitle: 'Éloge du Haerye',
  hunminAppraisalSub: 'Préface de Jeong In-ji · 鄭麟趾序',
  hunminEditorialNote: "Note de l'éditeur",
  hunminEditorialShow: "Afficher la note",
  hunminEditorialHide: "Masquer la note",
  hunminEditorialSource:
...
const de: Messages = {
  ...
  hunminInitialSub: 'Choseong · 初聲',
  hunminMedialTitle: 'Medial-Vokale',
  hunminMedialSub: 'Jungseong · 中聲',
  hunminAppraisalTitle: 'Würdigung im Haerye',
  hunminAppraisalSub: 'Vorrede von Jeong In-ji · 鄭麟趾序',
  hunminEditorialNote: 'Herausgeberhinweis',
  hunminEditorialShow: 'Hinweis einblenden',
  hunminEditorialHide: 'Hinweis ausblenden',
  hunminEditorialSource:
...
const es: Messages = {
  ...
  hunminInitialSub: 'Choseong · 初聲',
  hunminMedialTitle: 'Vocales mediales',
  hunminMedialSub: 'Jungseong · 中聲',
  hunminAppraisalTitle: 'Elogio en el Haerye',
  hunminAppraisalSub: 'Prefacio de Jeong In-ji · 鄭麟趾序',
  hunminEditorialNote: 'Nota del editor',
  hunminEditorialShow: 'Mostrar nota',
  hunminEditorialHide: 'Ocultar nota',
  hunminEditorialSource:
...
const hi: Messages = {
  ...
  homeIntroPart1:
    "1443 में राजा सेजोंग द्वारा 'हुनमिंजेओंगम' के निर्माण के समय प्रस्तुत किए गए 'सांघियोंग' के सिद्धांतों को,",
  homeIntroPart2:
  ...
  hunminInitialSub: 'चोसोंग · 初聲',
  hunminMedialTitle: 'मध्य स्वर',
  hunminMedialSub: 'जुंगसोंग · 中聲',
  hunminAppraisalTitle: 'हाएरये में मूल्यांकन',
  hunminAppraisalSub: 'जोंग इन-जी की प्रस्तावना · 鄭麟趾序',
  hunminEditorialNote: 'संपादकीय नोट',
  hunminEditorialShow: 'नोट दिखाएँ',
  hunminEditorialHide: 'नोट छिपाएँ',
  hunminEditorialSource:
...
const vi: Messages = {
  ...
  hunminAppraisalTitle: 'Đánh giá trong Haerye',
  research: 'Giới thiệu nghiên cứu',
  researchCardDesc: 'Thông tin dự án NRF, giới thiệu nhóm nghiên cứu, mục tiêu và ý nghĩa.',
  researchCta: 'Xem giới thiệu',
  homeResearchLabel: 'SCIENTIFIC APPROACH',
  homeResearchTitle: 'The Secret of Hunminjeongeum, Revealed by MRI',
  homeResearchDesc1:
    '580 years ago, King Sejong observed the human vocal organs with precision and created Hangeul.',
  ...
  homeResearchStatValue: '73',
  homeResearchStatSub: 'Seoul · Jeju · Mandarin speakers',
  researchPageDesc: 'Thông tin dự án NRF, giới thiệu nhóm nghiên cứu, mục tiêu và ý nghĩa.',
  researchSec1: 'Nhóm nghiên cứu',
  researchSec2: 'Mục tiêu và ý nghĩa',
  researchSec3: 'Thông tin dự án',
...
const ru: Messages = {
  ...
  hunminAppraisalTitle: 'Оценка в «Хэрё»',
  research: 'Исследование',
  researchCardDesc: 'Сведения о проекте NRF, исследовательской группе, целях и значении.',
  researchCta: 'Подробнее',
  researchPageDesc: 'Сведения о проекте NRF, исследовательской группе, целях и значении.',
  researchSec1: 'Исследовательская группа',
  researchSec2: 'Цели и значение',
  researchSec3: 'Сведения о проекте',
...
const ar: Messages = {
  ...
  hunminAppraisalTitle: 'تقدير في هاريي',
  research: 'تعريف بالبحث',
  researchCardDesc: 'معلومات مشروع NRF وتعريف بفريق البحث وأهدافه ومغزاه.',
  researchCta: 'عرض التعريف',
  researchPageDesc: 'معلومات مشروع NRF وتعريف بفريق البحث وأهدافه ومغزاه.',
  researchSec1: 'فريق البحث',
  researchSec2: 'الأهداف والمغزى',
  researchSec3: 'معلومات المشروع',
  admin: 'صفحة المسؤول',
}
